...
To install `gurobi`, follow the steps in [this article](https://cran.r-project.org/web/packages/prioritizr/vignettes/gurobi_installation.html). Specifically, you should:
